...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#<%= radIsSponsor.ClientID %>").change(function () {
            ...
            if ($("#<%= radIsSponsor.ClientID %>").find('input:checked').val() == "Yes") {
                display = "table-row";
            }

            $("#trSponsorId").css("display", display);
        });
        ...
        function BillingDisplay() {
            ...
            if ($("#<%= radBilling.ClientID %>").find('input:checked').val() == "Yes") {
                display = "none";
                enabled = false;
            }

            $("#tblBilling").css("display", display);
            ValidatorEnable($("#<%= RequiredFieldValidator14.ClientID %>")[0], enabled);
            ValidatorEnable($("#<%= RequiredFieldValidator4.ClientID %>")[0], enabled);
            ValidatorEnable($("#<%= RequiredFieldValidator5.ClientID %>")[0], enabled);
...
<table>
    <tbody>
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblFirstName" class="BBFieldCaption ChildSearchFieldCaption">First Name: *</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblEveningPhone" class="BBFieldCaption ChildSearchFieldCaption">Evening Phone (XXX) XXX-XXXX</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="style4">&nbsp;<asp:TextBox ID="txtEmail" runat="server" Width="126px"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td class="style2">
                                        <span id="PC1689_ctl00_lblCurrentSponsor" class="BBFieldCaption ChildSearchFieldCaption">Are You a Current Sponsor?</span> <span class="NCC_ScholarshipApp_requiredIndicator">&nbsp;*</span>
                                    </td>
                                    <td>
                                        <asp:RadioButtonList ID="radIsSponsor" runat="server" RepeatDirection="Horizontal">
                                ...
                                <tr id="trSponsorId" style="display: none;">
                                    <td class="style2">
        ...
        <tr>
            <td class="style1">&nbsp;<asp:Button ID="btnSubmit" runat="server" Text="Checkout" ValidationGroup="Checkout"
