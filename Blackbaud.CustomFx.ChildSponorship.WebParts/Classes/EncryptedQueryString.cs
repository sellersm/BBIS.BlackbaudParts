//taken from http://www.blackbeltcoder.com/Articles/security/encrypting-query-arguments
using System;
...
namespace Blackbaud.CustomFx.ChildSponorship.WebParts.Classes
{
    public class EncryptedQueryString : Dictionary<string, string>
    {
        ...
        protected string _keyString = "0N3CH1LDM@tt345";
        ...
        public EncryptedQueryString(string encryptedData)
        {
            ...
            {
                throw new ArgumentNullException("encryptedData is null or empty.");
            }
        }
