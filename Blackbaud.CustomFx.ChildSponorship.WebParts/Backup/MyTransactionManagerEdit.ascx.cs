    ...
    public partial class MyTransactionManagerEdit : BBNCExtensions.Parts.CustomPartEditorBase
    {
        ...
        public override void OnLoadContent()
        {
            if (!IsPostBack)
            {
                ...
                chkShowChildInsteadOfDesignation.Checked = MyContent.ShowChildInsteadOfDesignation;
            }
        }
        ...
        public override bool OnSaveContent(bool bDialogIsClosing = true)
        {
            ...
            MyContent.ShowChildInsteadOfDesignation = chkShowChildInsteadOfDesignation.Checked;
