...
<%@ Register TagPrefix="uc" TagName="PageLink" Src="~/Support Parts/PageLink.ascx"  %>
<table>
    <tr>
    ...
    <tr>
        ...
        <td><uc:PageLink ID="plinkCountryPage" runat="server" /><asp:TextBox ID="txtCountry" runat="server" /></td>
    </tr>
    <tr>
