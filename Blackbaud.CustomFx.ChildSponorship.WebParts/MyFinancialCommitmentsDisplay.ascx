<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyFinancialCommitmentsDisplay.ascx.cs" Inherits="Blackbaud.CustomFx.ChildSponsorship.WebParts.MyFinancialCommitmentsDisplay" %>
<asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="0">
    <asp:View ID="viewCommitments" runat="server">
        <asp:GridView ID="gvCommitments" runat="server" AutoGenerateColumns="False" 
            GridLines="None" 
            EmptyDataText="You do not have any financial commitments." 
            onrowcommand="gvCommitments_RowCommand">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkPayments" runat="server" Text="View Payments" CommandName="ViewPayments" CommandArgument='<%#Eval("Id") %>' />
                        <asp:LinkButton ID="lnkPay" runat="server" Text="Make Payment" CommandName="MakePayment" CommandArgument='<%#Eval("Id") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Commitment" HeaderText="Commitments" />
                <asp:BoundField DataField="Amount" HeaderText="Amount" />
                <asp:BoundField DataField="Frequency" HeaderText="Frequency" />
                <asp:BoundField DataField="AutoPay" HeaderText="AutoPay" />
            </Columns>
        </asp:GridView>
    </asp:View>
        ...
        <asp:GridView ID="gvPayments" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="BALANCE" DataFormatString="{0:c}" 
                    HeaderText="Balance" />
                <asp:BoundField DataField="DATE" DataFormatString="{0:M/dd/yyyy}" 
                    HeaderText="Date" />
            </Columns>
        </asp:GridView>
    </asp:View>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="cmbCcExpYear" Text="*" ErrorMessage="Credit Card Expiration Year" ValidationGroup="Checkout" />
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <asp:View ID="viewThankYou" runat="server">
        <asp:Label id="lblSummary" runat="server" /><br /><br />
